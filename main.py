...
print(f"[INFO] : Génération du code terminée en {time.time() - t} secondes")

with open("sortie.bf", "w") as f:
    f.write(instructions)

print("[INFO] : Execution du code")
t = time.time()
if args.runc:
...
print(f"[INFO] : Execution du code terminée en {time.time() - t} secondes")